      ...
      <div className="postDes">
        ...
        <div className="des">
          <p>
            ...
            game streaming verified partner by Streamy
            ...
            access to games a month before the official release. This is a dream
            come true, thanks to all for the support!!!
          </p>
        </div>
      ...
      <div className="likebtn">
        <div className="likeBtnIcons">
          <div className="icons">
            ...
            <div className="icon">
              <img src={dislikebtn} alt="dislikebtn" /> <span>Dislike</span>
            </div>
            <div className="icon">
